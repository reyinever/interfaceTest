...
<tr>
    <th>接口 URL</th><th>请求数据</th><th>接口响应数据</th><th>接口调用耗时(单位：ms)</th><th>断言数据</th><th>测试结果</th>
</tr>
...
if __name__ == '__main__':
	...
	data = [('url', 'requestData', 'responseData','escaptTime','assertData', 'result')]
	html_name=get_report_name()
	print(html_name)
